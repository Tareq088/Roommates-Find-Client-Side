            ...
            <main>
                <div className='w-11/12 mx-auto flex justify-center'>
                    ...
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs sm:w-sm md:w-md border p-4">
                        ...
                        <select name='room_type' defaultValue="Choose Room Type" className="select w-full" required>
                        ...
                        <select name='style_preference' defaultValue="Choose style preference" className="select w-full" required>
                        ...
                        <textarea name="description" cols={5} rows={10} className="input w-full" required></textarea>
                                        {/* contact info */}
                        <label className="label">Contact Info</label>
                        <input type="tel" name='contact_info' className="input w-full" placeholder="Contact Information" />
                                        {/* availability */}
                        <label className="label">Availability</label>
                        <select name='availability' defaultValue="select availability" className="select w-full" required>
